...
const Calc = () => {
  ...
  const calculate = (prevValue, currentValue, op) => {
    ...
    const scaledCurrent =
      current.int * 10n ** BigInt(maxDecimals - current.decimals);
  ...
  const Button = ({
    ...
    const variants = {
      ...
      operation:
        "bg-gradient-to-br from-cyan-500 via-cyan-600 to-cyan-700 text-white shadow-cyan-500/30 hover:from-cyan-400 hover:to-cyan-600 active:shadow-[inset_0_4px_0_rgba(0,0,0,0.25)]",
      equals:
        "bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-700 text-white shadow-emerald-500/30 hover:from-emerald-400 hover:to-emerald-600 active:shadow-[inset_0_4px_0_rgba(0,0,0,0.25)]",
      clear:
        "bg-gradient-to-br from-red-500 via-red-600 to-red-700 text-white shadow-red-500/30 hover:from-red-400 hover:to-red-600 active:shadow-[inset_0_4px_0_rgba(0,0,0,0.25)]",
    };
